...
import { fetchMachines, startMachine } from "../../api/machines"; // <-- Updated

export default function DetailsScreen() {
  const router = useRouter();
  const { id } = useLocalSearchParams() as { id: string };
  const [machine, setMachine] = useState(null); // New state
  ...
  // Fetch machines from the back-end and find the matching machine
  useEffect(() => {
    fetchMachines()
      .then((data) => {
